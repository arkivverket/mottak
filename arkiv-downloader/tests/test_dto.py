...
from arkiv_downloader.models.dto import ArkivuttrekkTransferRequest, ArkivuttrekkTransferStatus, TransferStatus
...
def test_ArkivuttrekkTransferInfo_from_correct_string():
    ...
    a = ArkivuttrekkTransferRequest.from_string(json_string)
    assert a
